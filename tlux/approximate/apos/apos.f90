...
MODULE APOS
  ...
  TYPE, BIND(C) :: MODEL_CONFIG
     ...
     INTEGER :: SAL, EAL ! A_LENGTHS(ADS,MIN(ANS-1,NUM_THREADS))
     INTEGER :: SML, EML ! M_LENGTHS(MDS,MIN(MNS-1,NUM_THREADS))
     INTEGER :: SAST, EAST ! A_STATE_TEMP(NA,ADS,MIN(ANS-1,NUM_THREADS))
     INTEGER :: SMST, EMST ! M_STATE_TEMP(NM,MDS,MIN(MNS-1,NUM_THREADS))
     ...
     INTEGER :: SAO, EAO ! A_ORDER(ADS,MIN(ANS-1,NUM_THREADS))
     INTEGER :: SMO, EMO ! M_ORDER(MDS,MIN(MNS-1,NUM_THREADS))
