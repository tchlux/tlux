...
- 2026-07-13: Added token-only tool retrieval, a one-completion grounded result path, bounded model queries, and confidence-triggered semantic/lexical fallback lanes. A 100-sample live cross-corpus gate retained 1.000 content-evidence recall; median one-completion agent latency was about 2.7-3.0 s.
