...
- 2026-07-13: Replayed the captured 50-sample Gemma query set after the high-score/no-evidence fix: content-evidence recall and precision@1 are both 1.000 with zero errors. A fresh live 50-sample generation rerun remains pending while the local model server is unavailable.
