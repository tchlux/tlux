...
- [ ] Close the random language gate. The fixed 40-case Fourth Wing baseline now reaches evidence recall@5/precision@1/MRR of 0.775/0.550/0.646; a post-validation eight-case Gemma 3 smoke reaches 0.875/0.875/0.875 overall with 6/8 genuine model queries, so precision and missing-entity recall remain open.
