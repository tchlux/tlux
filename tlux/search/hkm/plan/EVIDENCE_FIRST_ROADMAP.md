...
- [x] Enforce structured JSON query output for LM Studio and disable hidden reasoning in the planner request. The all-395 live Gemma gate reached 0.924 first-pass recall and 0.830 precision@1, then 1.000 final evidence recall/precision@1 with no planner errors and 7.6% fallback.
