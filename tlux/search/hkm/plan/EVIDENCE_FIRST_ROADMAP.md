...
- [ ] Gate the expanded heterogeneous language corpus. The valid 512-file FineWeb profile index reaches 0.906/0.750/0.807 recall/precision/MRR on a deterministic 32-case slice; generic-term and rarity-stratified model-first gates remain to be run.
