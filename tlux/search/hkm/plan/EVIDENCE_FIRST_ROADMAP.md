...
- [ ] Close the random language gate. The fixed 40-case Fourth Wing baseline now reaches evidence recall@5/precision@1/MRR of 0.850/0.600/0.708. Model refinement is capped at four lanes while deterministic recovery retains seven; a current eight-case Gemma 3 smoke reaches 1.000/1.000/1.000, but larger precision and conditional-query gates remain open.
