...
- [ ] Reduce the remaining tail latency. Current deterministic-first median/p95 result latency is 88/1,122 ms on the repository and 256/358 ms on prose; the live one-completion Gemma lane is 1.57/2.85 s on a fresh 50-sample repository gate served directly by llama.cpp with reasoning disabled.
