...
- [ ] Reduce the remaining tail latency. Candidate-first lexical ranking now measures 254/361 ms median/p95 on all 395 prose chunks with perfect evidence quality; the all-395 live one-completion Gemma lane remains 2.65/3.09 s median/p95, so model generation is still the dominant cost.
