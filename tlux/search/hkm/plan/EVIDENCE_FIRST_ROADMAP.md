...
- [ ] Close the random language gate. The fixed 40-case Fourth Wing baseline now reaches evidence recall@5/precision@1/MRR of 1.000/0.900/0.935; conditional precision@1 is 0.800 and missing-entity precision@1 is 0.900. LM refinement is capped at four lanes by default, while `--always-refine` forces an auditable inspection round. The broader random-corpus quality gate remains open.
