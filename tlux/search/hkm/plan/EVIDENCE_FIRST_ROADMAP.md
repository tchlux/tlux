...
- [ ] Close the random language gate. The fixed 40-case Fourth Wing baseline now reaches evidence recall@5/precision@1/MRR of 0.725/0.450/0.571; a fresh 20-case LM smoke reaches 1.000/0.800/0.888 with 20/20 generated queries, so precision remains the open target.
