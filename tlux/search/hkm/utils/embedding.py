...
from contriever.inference import tokenize, detokenize, embed
# from .e5.inference import tokenize, detokenize, embed


MAX_SEQ_LEN    = 512
DEFAULT_WINDOWS = (8, 32, 128, 512)
DEFAULT_OVERLAP = 0.5
...
if __name__ == "__main__":
    ...
    vecs, windows_meta = embed_windowed(tokens)
    print(vecs.shape)
    print(windows_meta)
